...
#ifdef R__LINUX
   virtual void VisitInt64Field(const RField<long long> &field) { VisitField(field); }
#endif
...
#ifdef R__LINUX
   virtual void VisitUInt64Field(const RField<unsigned long long> &field) { VisitField(field); }
#endif
...
#ifdef R__LINUX
   void VisitInt64Field(const RField<long long> &field) final;
#endif
...
#ifdef R__LINUX
   void VisitUInt64Field(const RField<unsigned long long> &field) final;
#endif
