...
void ROOT::Experimental::Internal::RHashValueVisitor::VisitInt8Field(const RIntegralField<std::int8_t> & /* field */)
{
   fHash = std::hash<std::int8_t>()(*static_cast<std::int8_t *>(fValuePtr));
}

void ROOT::Experimental::Internal::RHashValueVisitor::VisitInt16Field(const RIntegralField<std::int16_t> & /* field */)
{
   fHash = std::hash<std::int16_t>()(*static_cast<std::int16_t *>(fValuePtr));
}

void ROOT::Experimental::Internal::RHashValueVisitor::VisitInt32Field(const RIntegralField<std::int32_t> & /* field */)
{
   fHash = std::hash<std::int32_t>()(*static_cast<std::int32_t *>(fValuePtr));
}

void ROOT::Experimental::Internal::RHashValueVisitor::VisitInt64Field(const RIntegralField<std::int64_t> & /* field */)
{
   fHash = std::hash<std::int64_t>()(*static_cast<std::int64_t *>(fValuePtr));
}

void ROOT::Experimental::Internal::RHashValueVisitor::VisitUInt8Field(const RIntegralField<std::uint8_t> & /* field */)
{
   fHash = std::hash<std::uint8_t>()(*static_cast<std::uint8_t *>(fValuePtr));
}

void ROOT::Experimental::Internal::RHashValueVisitor::VisitUInt16Field(
   const RIntegralField<std::uint16_t> & /* field */)
{
   fHash = std::hash<std::uint16_t>()(*static_cast<std::uint16_t *>(fValuePtr));
}

void ROOT::Experimental::Internal::RHashValueVisitor::VisitUInt32Field(
   const RIntegralField<std::uint32_t> & /* field */)
{
   fHash = std::hash<std::uint32_t>()(*static_cast<std::uint32_t *>(fValuePtr));
}

void ROOT::Experimental::Internal::RHashValueVisitor::VisitUInt64Field(
   const RIntegralField<std::uint64_t> & /* field */)
{
